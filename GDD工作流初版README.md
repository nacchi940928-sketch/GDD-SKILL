...
| 可复用的 Prompt + Skill 知识库，支撑**策划创作辅助（P0）**、拆解、补全与编译交付 | 替代策划最终定案（01 须策划确认） |
| design 仓库的**规格文档真相来源**，入库后交程序开发 | P0 草稿直接进 P2（须先 P1 定稿） |

**交付目标**：程序管线以 **02 + 03** 为唯一可执行输入；P0 产出为策划创作草稿，**不替代** 01 定稿。
...
已有完整 docx/01 的功能**可跳过 P0**，直接从 P1 进入。
...
| 段 | 提示词数 | 索引 |
|----|----------|------|
| P0 立项探索（可选） | 4 | [prompts/P0/](GDD%20SKILL/prompts/P0/) |
...
完整索引：[prompts/README.md](GDD%20SKILL/prompts/README.md)（共 26 个提示词）
...
- [x] P0 立项提示词（GameDNA / Skill 选型 / 01 草稿，策划创作辅助）
