...
> **路径**：`{feature_root}` = `案例/{功能名}`。产出目录 = `{feature_root}/02-需求拆解/{功能名}/…`  
> 拆解前 @：`{feature_root}/01-原始策划案/{功能名}/原始策划案.md`  
> 详见 [使用指导.md](../../使用指导.md)
...
| 提示词 | 输出目录（相对仓库根 `GDD SKILL/`） |
|--------|-------------------------------------|
| P2-DS-数据源.md | `案例/{功能名}/02-需求拆解/{功能名}/数据源/` |
| P2-R-规则.md | `案例/{功能名}/02-需求拆解/{功能名}/规则/` |
| P2-EX-边界条件.md | `案例/{功能名}/02-需求拆解/{功能名}/边界条件/` |
| P2-SM-状态机.md | `案例/{功能名}/02-需求拆解/{功能名}/状态机/` |
| P2-UI-UI交互.md | `案例/{功能名}/02-需求拆解/{功能名}/UI交互/` |
| P2-RD-红点.md | `案例/{功能名}/02-需求拆解/{功能名}/红点/` |
| P2-V-校验规则.md | `案例/{功能名}/02-需求拆解/{功能名}/校验规则/` |
| P2-T-验收标准.md | `案例/{功能名}/02-需求拆解/{功能名}/验收标准/` |
